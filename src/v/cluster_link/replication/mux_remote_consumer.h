...
public:
    ...
    void add(const ::model::topic_partition&);
    ss::future<> remove(const ::model::topic_partition&);
     ...
     */
    void reset(const ::model::topic_partition& tp, kafka::offset);
...
private:
    ...
    chunked_hash_map<::model::topic_partition, partition_data_queue>
      _partitions;
