...
struct translation_status {
    ...
    size_t memory_bytes_reserved{0};
};
...
public:
    ...
    size_t slices_scheduled() const { return _slices_scheduled; }
...
private:
    ...
    // Total number times a translator was scheduled to
    // scheduled for translation.
    size_t _slices_scheduled{0};
