...
translator_executable::operator=(translator_executable&& other) noexcept {
    ...
    _slices_scheduled = other._slices_scheduled;
...
std::ostream& operator<<(std::ostream& os, const translator_executable& state) {
    fmt::print(
      os,
      "{{translator: {}, time_since_start: {}, total_wait_time: {}, "
      "total_running_time: {},  slices_scheduled: {}, stop_in_progress: {}, "
      "running: {}, waiting: {}}}",
      *state._translator,
      std::chrono::duration_cast<std::chrono::milliseconds>(
