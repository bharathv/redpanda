...
std::ostream&
operator<<(std::ostream& o, const translated_data_file_entry& entry) {
    fmt::print(
      o,
      "{{partition: {}, begin offset: {}, end offset: {}, translator term: {}, "
      "translation result: {}}}",
      entry.tp,
      entry.begin_offset,
      entry.end_offset,
      entry.translator_term,
...
operator<<(std::ostream& o, const fetch_latest_data_file_reply& reply) {
    fmt::print(o, "{{errc: {}, entry: {}}}", reply.errc, reply.entry);
    return o;
}
