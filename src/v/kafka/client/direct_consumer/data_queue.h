...
public:
     ...
     * If the timeout is reached, it will return empty fetches.
     */
     ...
     */
    void set_max_bytes(size_t bytes) { _max_bytes = bytes; }
    void set_max_count(size_t count) { _max_count = count; }
