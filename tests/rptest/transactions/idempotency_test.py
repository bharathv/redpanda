...
class IdempotentProducerRecoveryTest(RedpandaTest):
    ...
    recieves an unknown_producer_id error and bumps the epoch, resets
    the sequence number and retries again to make forward progress. There
    are subtle variations among client implementations around how they deal
